...
public class OrderedDatesUnitTests
{
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.Count))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.AsSpan))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.AsMemory))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.Contains))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.IndexOfOrPreviousElement))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.IsSorted))]
	...
	[TestMethod]
	[TestCategory(nameof(OrderedDates.AsCollection))]
